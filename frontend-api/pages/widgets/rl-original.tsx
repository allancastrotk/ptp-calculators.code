...
export default function RlOriginalWidget() {
  ...
  /*
   * Elemento real usado como autoridade
   * para a altura do iframe.
   */
  const resizeRootRef =
    useRef<HTMLDivElement | null>(null);

  /*
   * Autoajuste dinâmico de altura.
   *
   * Mede apenas o conteúdo real do widget,
  ...
  useEffect(() => {
    ...
    /*
     * Detecta crescimento/encolhimento:
     *
     * - Compressão OFF/ON
     * - Simples/Avançado
     * - resultados
    ...
    /*
     * Complementa o ResizeObserver
     * acompanhando mudanças estruturais
     * do React/DOM.
     */
    ...
    /*
     * O pai pode solicitar uma medição
     * explícita a qualquer momento.
     */
    ...
    /*
     * Mudança de largura/orientação pode
     * reorganizar todo o formulário.
     */
    ...
    /*
     * Fontes podem alterar geometria
