...
const dictionaries: Record<Language, Record<string, string>> = {
  en_US: {
    ...
    compareDeclaredLabel: "Compare with declared displacement (optional)",
    compareDeclaredHelp:
      "Optional: compare the calculated result against a stated displacement (does not change the calculation).",
  ...
  pt_BR: {
    ...
    compareDeclaredLabel: "Comparar com cilindrada declarada (opcional)",
    compareDeclaredHelp:
      "Use apenas para comparar o resultado calculado com a cilindrada informada (nao altera o calculo).",
  ...
  es_ES: {
    ...
    normalizedInputsTitle: "Entradas normalizadas (mm)",
    compareDeclaredLabel: "Comparar con cilindrada declarada (opcional)",
    compareDeclaredHelp:
      "Opcional: compara el resultado calculado con una cilindrada declarada (no altera el calculo).",
