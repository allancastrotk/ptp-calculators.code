...
const dictionaries: Record<Language, Record<string, string>> = {
  en_US: {
    ...
    measureMetricLabel: "Metric size",
    measureFlotationLabel: "Flotation size",
    Car: "Car",
  ...
  pt_BR: {
    ...
    measureMetricLabel: "Medida Metrico",
    measureFlotationLabel: "Medida Flotation",
    Car: "Carro",
    Motorcycle: "Moto",
  ...
  es_ES: {
    ...
    flotationLabel: "Medida flotation (opcional)",
    measureMetricLabel: "Medida Metrica",
    measureFlotationLabel: "Medida Flotation",
    Car: "Carro",
    Motorcycle: "Moto",
